...
public class MyTest {
    ...
    public static void main(String[] args) throws IllegalAccessException, InstantiationException {
        ...
        enhancer.setSuperclass(MyCalculator.class);
        //设置enhancer的回调对象
        enhancer.setCallbackTypes(new Class[]{MyCglib.class});
        //创建代理对象
        Class<MyCalculator> klass = enhancer.createClass();
        MyCalculator myCalculator = klass.newInstance();
        
        ((Factory) myCalculator).setCallback(0, new MyCglib());
